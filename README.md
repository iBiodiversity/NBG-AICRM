...
🚧 Work in Progress The formal documentation and codebase in this repository are currently being updated to reflect the latest research findings.
...
🚧 更新说明 本仓库的正式文档与代码目前正在同步更新中，即将发布。

如需查看处于开发更新当中的参考模型预览版及交互工具，请访问： 👉 https://www.ibiodiversity.cn/App/NBG-AICRM/
